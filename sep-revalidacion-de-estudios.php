...
<head>
    ...
    <title>Gestores en México | Revalidación de estudios</title>
    ...
    <meta property="og:title"              content="Revalidación de estudios" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                <h1 class="titulo mayus">Revalidación de estudios</h1>
                <p>Haz validos tus estudios como mexicano con estudios en el extranjero o como extranjero con estudios en México. Lo hacemos por ti.</p>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Revalidación de estudios</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            <span id="costoTramitePesos" class="costoNumeros">$ 400 <sup>mn</sup></span>
                            <span id="costoCopiasPesos" class="costoNumeros noDisponible">No disponible</span>
                            <span id="costoEnvioPesos" class="costoNumeros">$ 250 <sup>mn</sup></span>
                            <span id="costoTotalPesos" class="costoNumeros"><strong>$ 650 <sup>mn</sup></strong></span>
                        </div>
