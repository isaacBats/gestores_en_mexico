...
<head>
    ...
    <title>Gestores en México | Acta de defunción</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                <h1 class="titulo mayus">Acta de defunción</h1>
                <p>Tramite aquí el acta de defunción que solicita. La tramitamos por ti.</p>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Acta de defunción</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            <span id="costoTramitePesos" class="costoNumeros">$ 360 <sup>mn</sup></span>
                            ...
                            <span id="costoTotalPesos" class="costoNumeros"><strong>$610 <sup>mn</sup></strong></span>
                        </div>
