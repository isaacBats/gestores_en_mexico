...
<head>
    ...
    <title>Gestores en México | Acta de divorcio</title>
    ...
    <meta property="og:title"              content="Trámite de acta de divorcio" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                <h1 class="titulo mayus">Acta de divorcio</h1>
                <p>Obtén tu acta de divorcio, o acta de matrimonio con nota marginal de divorcio solicitándola aquí. La tramitamos por ti.</p>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Acta de divorcio</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            <span id="costoTramitePesos" class="costoNumeros">$ 660 <sup>mn</sup></span>
                            ...
                            <span id="costoTotalPesos" class="costoNumeros"><strong>$910 <sup>mn</sup></strong></span>
                        </div>
