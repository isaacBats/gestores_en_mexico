    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                ...
                <ul>
                    <li>5 o más documentos en copia del titular de la aclaración donde venga el dato correcto</li>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Aclaración acta de nacimiento</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <span id="costoTotalPesos" class="costoNumeros"><strong>$2,700 <sup>mn</sup></strong></span>
                        </div>
