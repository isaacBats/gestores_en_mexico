...
<head>
    ...
    <title>Gestores en México | Apostilla de documentos escolares</title>
    ...
    <meta property="og:title"              content="Apostilla de documentos escolares" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                ...
                <p>Continuaras tus estudios en otro país? O simplemente necesitas darle efecto legal en otro país? Necesitarás apostillarlo, sin importar de donde sea, nosotros lo hacemos por ti.</p>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Apostilla de documentos escolares</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <span id="costoEnvioPesos" class="costoNumeros">$ 200 <sup>mn</sup></span>
