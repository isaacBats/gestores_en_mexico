...
<head>
    ...
    <title>Gestores en México | Apostillado de Certificados de Estudios. Secundaria, Primaria, Terciarios y Universitarios</title>
    ...
    <meta property="og:title"              content="Apostillado de Certificados de Estudios. Secundaria, Primaria, Terciarios y Universitarios" />
...
<div class="aliceBlue paddingContent">
    <div class="container">
        <div class="row">
            ...
            <img src="images/bandera-Mexico.svg" class="imgSVG bandera" alt="Gestores en México" title="Gestores en México y Argentina" />
            <img src="images/bandera-Argentina.svg" class="imgSVG bandera" alt="Gestores en México" title="Gestores en México y Argentina" />

                <h1 class="titulo mayus">Apostillado de Certificados de Estudios. Secundaria, Primaria, Terciarios y Universitarios</h1>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-4">
                    <select name="estadoArg" id="estadoArg" class="form-control light">
                ...
                <div class="col-md-4">
                    <select name="estado" id="estado" class="form-control light">
                        ...
                        <option value="1-copias">1 Copia</option>
                        <option value="2-copias">2 Copias</option>
                        <option value="3-copias">3 Copias</option>
                        <option value="4-copias">4 Copias</option>
                        <option value="5-copias">5 Copias</option>
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="email" placeholder="Email">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="telefono" placeholder="Teléfono">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="celular" placeholder="Celular">
                </div>

                <div class="col-md-4">
                    <input class="form-control materail-input light" id="calle" placeholder="Calle">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="numeroext" placeholder="Número exterior">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="numeroint" placeholder="Número interior">
                </div>

                <div class="col-md-4">
                    <input class="form-control materail-input light" id="colonia" placeholder="Colonia">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="cp" placeholder="Código Postal">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="delmun" placeholder="Delegación / Municipio">
                </div>
                ...
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="estadodireccion" placeholder="Estado">
                </div>
                <div class="col-md-4">
                    <input class="form-control materail-input light" id="referencia" placeholder="Referencia">
                </div>
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Apostillado de Certificados de Estudios. Secundaria, Primaria, Terciarios y Universitarios</span></h4>
                    ...
                    <div class="col-md-12">
                        <label>
                            <input type="checkbox" id="copiarDatos" checked="checked" class="check"> He leído y acepto el <a href="aviso-de-privacidad.php" target="_blank" class="transitions">Aviso de Privacidad</a>
                        </label>
                    </div>

                    <button class="btn material-btn_lg material-btn_success main-container__column">Enviar mi solicitud</button>
                </div>
            </div>
        </div>
