...
<head>
    ...
    <title>Gestores en México | Apostilla de todo tipo de documentos</title>
    ...
    <meta property="og:title"              content="Apostilla de todo tipo de documentos" />
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 requisitos">
                <h1 class="titulo mayus">Apostilla de todo tipo de documentos</h1>
                <p>Si el documento que necesita apostillar no figura en el catálogo, pregúntenos si es posible apostillarlo, o envíenos la imagen por anversos y reveso a al correo contacto@gestoresenmexico.com Desde ya, estamos a tu disposición para realizar cualquier tipo de trámite que requiera ser apostillado.</p>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 form">
                ...
                <div class="col-md-12 calculoCosto">
                    <h4>Costo por concepto de <span class="tituloTramite">Apostilla de todo tipo de documentos</span></h4>
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <span id="costoCopiasPesos" class="costoNumeros noDisponible">No disponible</span>
